...
>
	...
	<button
		...
		class="absolute -right-3 top-20 w-6 h-6 bg-surface-700 border border-surface-600 rounded-full flex items-center justify-center text-surface-300 hover:text-white hover:bg-surface-600 transition-colors cursor-pointer z-50"
	>
		{#if collapsed}
