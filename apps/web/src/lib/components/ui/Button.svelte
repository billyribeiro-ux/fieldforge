<script lang="ts">
	...
	let classes = $derived(cn(
		'inline-flex items-center justify-center font-medium rounded-[var(--radius-button)] transition-all duration-[var(--transition-fast)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-forge-500 cursor-pointer',
		variants[variant],
		sizes[size],
